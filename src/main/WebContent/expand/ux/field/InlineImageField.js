		...
		if (!me.readOnly) {
			me.contextMenu = Ext.create('Ext.menu.Menu', {
				items : [{
					...
					tooltip : '请选择小于300K的类型为.jpg .jpeg .gif .bmp .png的文件',
					handler : function(){
			...
			items : [{
				...
				listeners : {
					change : function(field, newValue, oldValue){
						...
						else me.down('image').setSrc('images/system/noimage.png');
					}
				}
			}]
		}, {
		...
		change : function(filefield, value){
			...
			if (allImgExt.indexOf(fileExt + " ") != -1) {
				...
				if (fileInput != null) {
					...
					if (fileSize > 300) {
						EU.toastWarn('图片文件太大，请选择小于300K的图片文件！');
						filefield.reset();
						return;
					}
				}
