...
Ext.define('app.view.platform.central.region.Bottom', {
	...
	requires : [ 'expand.ux.ButtonTransparent',
			'app.view.platform.central.region.ButtomController','Ext.toolbar.Spacer','Ext.toolbar.Fill' ],
	...
	style : 'background-color : #f0f0f0' ,// #DAE5E8;',
	...
	items : [
			...
			{
				bind : {
					text : '{company.servicedepartment} '
							+ '{company.servicemen}',
