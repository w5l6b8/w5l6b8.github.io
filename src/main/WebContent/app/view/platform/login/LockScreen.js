Ext.define('app.view.platform.login.LockScreen', {
	...
	bodyStyle : "background:url('resources/images/lockbg.jpg') no-repeat;background-size:100%;",
	...
	beforeShow : function(){
		...
		this.photoImg.setSrc('login/getuserfavicon.do?userid=' + cfg.sub.userid + '&dc='
		    + new Date().getTime()),

		// this.photoImg.setSrc('platform/personnel/getphoto.do?_dc=' + new
		// Date().getTime() + '&companyid='
		// + cfg.sub.companyid + '&photoid=' + cfg.sub.photoid);
		this.l_username.getEl().setHtml('<h2><font  color="#ffffff"><span style="letter-spacing:2mm;text-shadow: 3px 3px 3px rgba(42, 42, 42, 0.75);">'
