...
Ext.define('app.view.platform.module.toolbar.widget.SearchField', {
				...
				if (!field.getValue()) {
					...
					if (field.searchfor == 'text') {
						...
						Ext.QuickTips.register({
							target : field.getEl(),
							text : '数值格式:<table><tr><td>数值</td><td>如 3.14</td></tr>'
									+ '<tr><td>></td><td>如 >3.14</td></tr>'
									+ '<tr><td>>=</td><td>如 >=3.14</td></tr>'
									+ '<tr><td><</td><td>如 <3.14</td></tr>'
									+ '<tr><td><=</td><td>如 <=3.14</td></tr>'
									+ '<tr><td><></td><td>如 <>3.14</td></tr>'
									+ '<tr><td>n1-n2(区间)</td><td>如 3.14-31.4</td></tr>'
									+ '</table>如要查多个以逗号分隔如 3.14,6.28',
							enabled : true,
							showDelay : 200,
							trackMouse : false,
							autoShow : true
						...
						Ext.QuickTips.register({
							...
							text : '日期格式:<table><tr><td>yyyy-mm-dd(年月日)</td><td>如:2000-07-29</td></tr>'
									...
									+ '<tr><td>yy-mm(年月)</td><td>如:00-07</td></tr>'
									+ '<tr><td>yyyy(年)</td><td>如:2000</td></tr>'
	...
	formatAChar : function(value, c) {
		if (value.length > 0) {
			...
			if (value.lastIndexOf(c) == value.length - 1)
