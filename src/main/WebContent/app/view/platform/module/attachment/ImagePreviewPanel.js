/**
 * 附件原始图片预览的panel,可以放大缩小，或者显示原始图片
 * 
 * @author jiangfeng
 * 
 *         www.jhopesoft.com
	  ...
	  tbar : [{
		      ...
		      listeners : {
			      click : function(button){
				      if (button.pressed) {
					      var p = button.up('imagepreviewpanel');
		      ...
		      handler : function(button){
			      button.up('imagepreviewpanel').printImage(button.up('imagepreviewpanel').url);
		      }
	      }],
	  items : [{
		      xtype : 'panel',
		      ...
		      items : [{
			          ...
			          listeners : {
				          resize : function(panel, width, height, oldWidth, oldHeight, eOpts){
					          panel.up('imagepreviewpanel').adjustSize();
				          }
			          }
		          }, {
			          itemId : 'normalpanel',
