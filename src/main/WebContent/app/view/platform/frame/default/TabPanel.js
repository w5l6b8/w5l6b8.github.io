/**
 * 主窗口TabPanel Ext.SystemTabPanelAutoOpens
 * 当前业务Panel面板中TabPanel对象自动打开菜单窗口Map对象{menuid:obj}
 */
Ext.define('app.view.platform.frame.default.TabPanel', {
	...
	initComponent : function(){
		var me = this;
		this.items = [Ext.create('app.view.platform.module.Module')];
